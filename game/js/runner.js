$(document).ready((event) => {
    ...
    var InfiniteRunner = Sketch.create({
        ...
        container: document.getElementById('runner_container')
    });

    //TODO - rewrite this class using the constructor pattern with ES6 classes.
    ...
    Player.prototype.draw = function() {
        ...
        InfiniteRunner.arc(this.x, this.y, this.width, 0, 2 * Math.PI, false);
        InfiniteRunner.fill();
    };
    ...
    function PlatformManager(){
        this.maxDistanceBetween = 400;
        this.colors = ["#000", "#880e4f", "#016FF9","#34B484", "#f0f0f0"];
    ...
    PlatformManager.prototype.updateWhenLose = function() {
        ...
        InfiniteRunner.fillStyle = this.color;
        InfiniteRunner.fillRect(this.x * 0.9, this.y, this.size, this.size);
        };
